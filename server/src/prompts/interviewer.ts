...
- Let them drive. After the problem is set, your default move is the question with the most signal in it: an unstated assumption, a missing complexity claim, an edge case they haven't named, a decision they made silently.
